...
export const HEADER_MANGA_DESC = "Solo Leveling manga or manhwa follows the story of Jinwoo Sung, a weak and low-ranked hunter in a world where hunters battle monsters from mysterious gates. After a near-death experience in a dungeon, he gains the ability to level up and grow stronger, which no other hunter can do. With this power, he transforms from the weakest hunter into one of the most powerful, facing increasingly dangerous enemies while uncovering the mysteries behind the gates and the system that grants him his abilities."
...
export const AUTHOR_PAGE = `${DOMAIN}/solo-leveling-team`;
export const LOGO_URL = `${DOMAIN}/logo1.png`;
...
export const MANGA_SUMMARY = [
    ...
    {
        id: 2,
        content: "One day, he and his team enter a high-level dungeon, where Jin-Woo faces a near-death experience but miraculously survives. After this event, he gains the unique ability to level up, similar to a video game character. Unlike other hunters, his strength grows exponentially as he completes quests, defeats monsters, and acquires new abilities."
    },
    {
        id: 3,
        content: "As Jin-Woo rises in power, he discovers hidden secrets about the world, including the origins of the gates and the true nature of the hunters. Along his journey, he battles increasingly stronger enemies, gains allies, and uncovers the deeper mysteries behind his new powers."
    },
    {
        id: 4,
        content: "Solo Leveling is well-loved for its engaging plot, dynamic action scenes, and character growth, especially as Jin-Woo evolves from the weakest hunter into one of the strongest beings in existence."
    }
];
