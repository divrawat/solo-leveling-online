...
export default function Home() {
    ...
    "@graph": [
      {
        ...
        "@id": `${DOMAIN}`,
        "url": `${DOMAIN}`,
        "name": "Read the legendary Solo Leveling manhwa",
        "isPartOf": {
          "@id": `${DOMAIN}/#website`
        },
        "about": {
  ...
  const head = () => (
    <Head>
      ...
      <meta name="keywords" content="solo leveling, solo leveling manga, solo leveling manhwa, read solo leveling, solo leveling anime, solo leveling read, baca komik solo leveling, baca solo leveling, solo leveling online, sololeveling, solo leveling 1, solo leveling chapter 1, solo leveling webtoon, manga like solo leveling, solo leveling comic, solo leveling1, solo max leveling, solo leveling 147, solo leveling 169, solo leveling light novel, solo leveling manga online, solo leveling read online, solo leveling 149, manga solo leveling, solo leveling 165, solo leveling reddit, only i level up, leveling solo, read solo levelling, solo leveling 168, solo leveling 170, read solo leveling online, solo leveling eng, solo leveling chapter, level up alone, baca manga solo leveling, manhwa like solo leveling, manhwa solo leveling, solo leveling manga read, solo leveling komiku, baca manhwa solo leveling, solo leveling animation, beru solo leveling, anime solo leveling, solo leveling fandom, manhwa similar to solo leveling, manga similar to solo leveling, manga like solo leveling with op mc, solo max level newbie chapter 1, solo leveling manga free, solo leveling anime netflix, thomas andre solo leveling, webtoon solo leveling, manhwa like solo leveling with op mc, solo leveling netflix, sololeveling manga, anime like solo leveling, solo leveling mangago, solo leveling beru, solo levelling manhwa, solo leveling manhwa online, solo leveling 3, solo leveling thomas andre, level up alone manga, manga like solo leveling reddit, manhwa like solo leveling art, solo leveling ao3, level up manga, solo leveling 4, solo max level newbie manga, solo leveling ending, anime solo, solo leveling 5, solo leveling last chapter, solo leveling anime mappa, leveling manhwa, solo leveling anime studio, solo max level newbie manhwa, sololeveling anime, solo leveling 180, solo max newbie, manhwa with leveling system, solo level max, solo leveling 178, solo leveling 179, solo leveling 176, solo leveling volume 5"></meta>
    </Head >
  );
      ...
      <article>
        ...
        <div className='max-w-[1200px] mx-auto md:flex rounded-md md:gap-[80px] bg-[black] mt-8 border border-[#373737] text-[white]'>
          ...
          <div className='md:w-[400px] md:pt-0 pt-6'>
            <img className='   md:mx-0 mx-auto' src={`${DOMAIN}/cover1.webp`} alt="Solo Leveling Cover" />
          </div>
          ...
          <div className=" mt-10 py-3 bg-black border border-[#323232] rounded max-w-[900px] mb-10 mx-auto px-3 flex flex-wrap justify-center max-h-[400px] overflow-y-scroll sm:gap-5 gap-3">
            ...
            {chapters?.map((chapter, index) => (
              <div className="flex hover:scale-105 active:scale-95 transition-transform my-1" key={index}>
                <Link prefetch={false} href={chapter.url} className="sm:p-5 p-1.5 text-center  hover:underline text-white bg-black hover:bg-[#2c2b2b] border border-[#292828] rounded sm:w-[160px] w-[110px]">
        ...
        <div className="flex justify-center"><img src={`${DOMAIN}/4.jpg`} alt={`${MANGA_NAME} Images`} /></div>
